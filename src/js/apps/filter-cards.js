// Filter + Card List UI: 검색/필터/정렬/무한스크롤 + 상태 렌더 + 최근검색어(sessionStorage) + 스켈레톤
(function () {
  const app = document.querySelector('[data-app-filter]');
  if (!app) return;
