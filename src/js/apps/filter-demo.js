// Filter Cards Demo: 검색/카테고리/태그/정렬/더 보기
(function () {
  ...
  const render = () => {
    ...
    moreEl.hidden = end >= filtered.length;
  ...
  moreEl.addEventListener('click', () => { state.page += 1; render(); });
